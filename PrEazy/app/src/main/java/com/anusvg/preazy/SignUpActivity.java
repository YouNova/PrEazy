...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button signUp = findViewById(R.id.buttonSignUp_SignUpPage);
    ...
    private void StoreUserDetails(final String ModeOfUser) {
        ...
        db.collection("UserTypeCategorize").document("Count").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
